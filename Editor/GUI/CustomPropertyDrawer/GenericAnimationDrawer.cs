...
internal class GenericAnimationDrawer : PropertyDrawer
{
    public override VisualElement CreatePropertyGUI(SerializedProperty property)
    {
        ...
        SerializedProperty curveBindingProperty = property.FindPropertyRelative(GenericAnimation.CurveBindingPropName);
        SerializedProperty curveProperty = property.FindPropertyRelative(GenericAnimation.CurvePropName);
        SerializedProperty objectReferenceCurveProperty = property.FindPropertyRelative(GenericAnimation.ObjectReferenceCurvePropName);

        // GenericAnimationのサマリー表示
        // 例えば、CurveBindingのPropertyNameを表示
        PropertyField propertyNameField = new PropertyField(curveBindingProperty.FindPropertyRelative(SerializableCurveBinding.PropertyNamePropName));
