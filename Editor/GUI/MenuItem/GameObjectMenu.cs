...
internal static class GameObjectMenu
{
    ...
    */
    ...
    static void OneHandGesture() => IP("3fed0a63141d68f4991a7a4c2ec7aae6");

    [M(CommonPath + "Two Hand Gesture")] 
    static void TwoHandGesture() => IP("c345a3d2b1af0ef45b86390b30e40051");

    // Condition
    private const string ConditionPath = BasePath + "Condition/";
    [M(ConditionPath + "Basic")] 
    static void ConditionBasic() => IP("c259edc6efd4aaa4bba3b1636557cc3b");

    [M(ConditionPath + "Blending")] 
    static void ConditionBlending() => IP("9eb5bf9eeb8dc81488fb9453d21f3510");

    [M(ConditionPath + "FaceMorph First")] 
    static void ConditionFaceMorphFirst() => IP("618bf06062904004f99355468c34ac7c");

    [M(ConditionPath + "HandSign")] 
    static void ConditionHandSign() => IP("e7a261d8cf051454ea0c41e427463276");

    [M(ConditionPath + "One Hand Gesture Condition Left")] 
    static void ConditionOneHandGestureLeft() => IP("9f044864c335d38499244290e12697d3");

    [M(ConditionPath + "One Hand Gesture Condition Right")] 
    static void ConditionOneHandGestureRight() => IP("73a1d844c3155444696e054ae47b9f7c");

    // Sample
    private const string SamplePath = BasePath + "Sample/";
    [M(SamplePath + "FaceTune Chiffon base")] 
    static void SampleFaceTuneChiffonBase() => IP("7771562b4cf54b949ab72930bff1bdc8");
