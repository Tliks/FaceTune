...
internal class ExpressionDataEditor : FaceTuneIMGUIEditorBase<DataComponent>
{
    ...
    private void UpdateInfo()
    {
        ...
        Component.GetAnimations(facialAnimations, _context.BodyPath);
    ...
    private void OpenEditor()
    {
        ...
        if (Component.TryGetComponentInParent<FaceTuneComponent>(true, out var expressionComponent)){
            foreach (var upperData in expressionComponent.GetComponentsInChildren<DataComponent>()) {
                ...
                upperData.GetFirstFrameBlendShapes(baseSet, bodyPath, facialStyleAnimations);

            }
        }
        var componentClipAnimations = new List<BlendShapeWeightAnimation>();
        Component.GetAnimations(componentClipAnimations, bodyPath, facialStyleAnimations);
...
internal class ExpressionDataClipImporter
{
    ...
    {
        var facialAnimations = new List<BlendShapeWeightAnimation>();
        component.GetAnimations(facialAnimations, bodyPath);
